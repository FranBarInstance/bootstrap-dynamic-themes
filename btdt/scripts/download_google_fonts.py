...
def download_font(font_name: str, base_dir: Path) -> Path:
    ...
    # Try variable weight range first (100..900)
    urls_to_try = [
        f"https://fonts.googleapis.com/css2?family={encoded_name}:wght@100..900&display=swap",
        f"https://fonts.googleapis.com/css2?family={encoded_name}:wght@400;700&display=swap",
        f"https://fonts.googleapis.com/css2?family={encoded_name}&display=swap",
    ]
